...
if len(parts) >= 2:
    # Use ONLY the VERY FIRST part to avoid the mangled duplicates that got inserted
    top_part = parts[0] + split_marker
...
"""
    ...
    print("Fixed farmar_id_form.html layout completely using part 0.")
else:
